...
- [`cocos-game-balance-director`](./cocos-game-balance-director): design tunable numbers, probability tables, economy loops, difficulty curves, and balance sanity checks.
- [`cocos-game-design-director`](./cocos-game-design-director): turn a Cocos mini-game idea into a playable design brief, core loop, vertical slice, and cross-skill handoffs.
...
- [`cocos-level-content-design`](./cocos-level-content-design): design levels, waves, missions, procedural rules, pacing, and reusable content data.
